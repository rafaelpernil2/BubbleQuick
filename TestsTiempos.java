 ...
 *
 *         Muestra groficas con el comportamiento experimental de la
 *         implementacion frente a otros motodos de ordenacion
 *
 */
...
public class TestsTiempos {
	...
	public static void testResolverTodos(GeneradorVector<Integer> generador, String subtitulo) {
		...
		int numTests = 20; // nomero de tests para cada tamaoo
		int minTam = 0, maxTam = 2000, saltoTam = 25; // tamaoos monimos, moximos y saltos

		final Grafica gr = new Grafica("Tiempo de ordenaci\u00f3n para distintos tama\u00f1os de vector", subtitulo,
				"Tama\u00f1o vector", "Milisegundos", "%.0f", "%.2f");
		...
		Resolutor resolutores[] = { new Resolutor("Ord Burbuja") {
	...
	public static void main(String args[]) {
		...
		testResolverTodos(GeneradoresVectorEnteros.aleatorio, "Datos inicialmente ordenados aleatoriamente");
